...
const Navbar = () => {
  ...
  const navLinks = [
    { name: "Home", path: "/", icon: Home, description: "Back to homepage" },
    {
      ...
      path: "/canteens",
      icon: ShoppingBag,
      description: "Browse all canteens",
    },
    {
      name: "Blog & News",
      path: "/admin/news",
      icon: FileText,
      description: "Read articles and news",
    },
    {
      name: "Reserve Table",
      path: "/reservation",
            ...
            {user ? (
              ...
              <>
                <Link to="/login">
                  <Button
                    variant="ghost"
                    className="text-surface-700 hover:bg-surface-100 px-3 py-1.5 text-sm"
                  >
                    Log in
                  </Button>
                </Link>
              ...
              {user ? (
                ...
                <>
                  <Link to="/login" onClick={() => setIsMobileMenuOpen(false)}>
                    <Button
                      variant="ghost"
                      className="w-full text-surface-700 hover:bg-surface-100 px-3 py-1.5 text-sm"
                    >
                      Log in
                    </Button>
                  </Link>
